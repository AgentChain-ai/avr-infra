...
from config.context_config import get_context_categories, get_priority_levels, get_category_color
...
def show_context():
    ...
    # Main tabs
    tab1, tab2, tab3, tab4 = st.tabs(["📝 Context Notes", "➕ Create Note", "📊 Analytics", "⚙️ Categories"])
    ...
    with st.form("create_context_note", clear_on_submit=True):
        ...
        if submitted:
            ...
            try:
                ...
                # Create context note
                new_note = api_client.create_context_note(note_data)
        ...
        with st.form("create_category_form"):
            ...
            if submitted:
                ...
                try:
                    ...
                    new_category = api_client.create_context_category(category_data)
    ...
    with st.form(f"edit_category_{category['id']}"):
        ...
        if save_clicked:
            ...
            try:
                ...
                updated_category = api_client.update_context_category(category['id'], update_data)
